...
//                 if (i > 0) {
//                     const Index prev = mFluidIndices[j * mMac.nx() + (i -
//                     1)];
...
//                 if (j > 0) {
//                     const Index prev = mFluidIndices[(j - 1) * mMac.nx() +
//                     i];
...
//                 if (i > 0) {
//                     const Index prev = mFluidIndices[j * mMac.nx() + (i -
//                     1)]; t -= mAx[prev] * mPreconditioner[prev] * dst[prev];
//                 }

//                 if (j > 0) {
//                     const Index prev = mFluidIndices[(j - 1) * mMac.nx() +
//                     i]; t -= mAy[prev] * mPreconditioner[prev] * dst[prev];
//                 }
...
//                 // viewport.
//                 if (i < mMac.nx() - 1) {
//                     const Index next = mFluidIndices[j * mMac.nx() + (i +
//                     1)]; t -= mAx[index] * mPreconditioner[index] *
//                     dst[next];
//                 }

//                 if (j < mMac.ny() - 1) {
//                     const Index next = mFluidIndices[(j + 1) * mMac.nx() +
//                     i]; t -= mAy[index] * mPreconditioner[index] * dst[next];
//                 }
